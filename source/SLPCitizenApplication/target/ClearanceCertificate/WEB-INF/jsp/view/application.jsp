...
<s:i18n name="lk.icta.resources.global">
    ...
    <div id="es-container" class="container">
        ...
        <div id="es-content">
            ...
            <p>If you need to get an extended clearance certificate for a
                previously approved one, then please select renewal. The clearance
                period has to be same as the previous certificate. A new certificate
                for the same period but for a different country also can be obtained
                through the renewal. Application charges are applicable.<br>
                An application can be renewed within one year from the date the clearance certificate was issued.
            </p>

            <s:form theme="simple" class="form-horizontal"
                    id="previousApplicationReferenceForm" role="form" method="post"
                    action="loadPreviousApplication.action"
                    onsubmit="return validateReApplyForm()">
                <div class="middle_content">
                    ...
                    <div id="previousReferenceForm" style="display: none;">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <div class="col-sm-4">
                                    <label for="previousReferenceNo" class="control-label"><b>Previous
                                        Application Reference No.</b></label>
                                </div>
                                <div class="col-sm-3">
                                    <s:textfield name="applicationVO.previousReferenceNo"
                                                 id="previousReferenceNo" cssClass="form-control"
                                                 autocomplete="off"/>
                                </div>
                                <div class="col-sm-2">
                                    <input type="submit" class="btn btn-primary es-buttton"
                                           value="Load"/>
                                </div>
                            </div>
                        </div>
            ...
            <div class="middle_content">
                        ...
                        <div class="col-sm-6">
                            <c:choose>
                                <c:when test="${applicationVO.nationalityId != null}">
                                    <select name="applicationVO.nationalityId"
                                            id="nationalitySelect" class="form-control"
                                            onchange="wereYouCitizenOfSriLankaShowHide();">
                ...
                <div id="sriLankaCitizenDiv">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <div class="col-sm-6">
                                <label for="citizenOfSriLankaSelect" class="control-label"><b>Were
                                    you a citizen of Sri Lanka?</b></label>
                            </div>
                            <div class="col-sm-4">
                                <c:choose>
                                    <c:when test="${applicationVO.citizenOfSriLanka != null}">
                                        <select name="applicationVO.citizenOfSriLanka"
                                                id="citizenOfSriLankaSelect" class="form-control"
                                                onchange="changeStatuscCtizenOfSriLanka();">
                                            <c:choose>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <div class="col-sm-6">
                                <label for="dateOfcitizenshipObtained" class="control-label"><b>If
                                    Yes, the date citizenship obtained from another country</b></label>
                            </div>
                            <div class="col-sm-4">
                                <s:textfield name="dateOfCitizenshipObtained"
                                             id="dateOfcitizenshipObtained" cssClass="form-control"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-sm-4">
                            <label for="dateOfBirth" class="control-label"><b><span
                                    class="mandatory_field">*</span>Date Of Birth</b></label>
                        </div>
                        <div class="col-sm-6">
                            <s:textfield name="dateOfBirth" id="dateOfBirth"
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-sm-6">
                            <label for="applicantAge" class="control-label"><b><span
                                    class="mandatory_field">*</span>Age in years:</b></label>
                        </div>
                        <div class="col-sm-4">
                            <s:textfield name="applicationVO.age" id="applicantAge"
                    ...
                    <div class="form-group">
                        <div class="col-sm-4">
                            <label for="nicValidate" class="control-label"><b><span
                                ...
                                Did you leave Sri Lanka before the age 16 ?</b></label>
                        </div>
                        <div class="col-sm-6">
            ...
            <s:form theme="simple" class="form-horizontal"
                    id="applicationVerificationForm" role="form" method="post"
                    action="verifyApplication.action"
                    onsubmit="return validateVerificationForm();">

                <s:hidden name="applicationVO.nationalityId"
                          id="nationalityIdVerify"/>
                ...
                <s:hidden name="applicationVO.citizenOfSriLanka"
                          id="citizenOfSriLankaVerify"/>
                <s:hidden name="dateOfCitizenshipObtained"
                          id="citizenshipObtainedDateVerify"/>
                ...
                <input type="hidden" name="applicationReferenceNoValue"
                       id="applicationReferenceNoValue"
                ...
                <div class="middle_content">
                    ...
                    <p>Application with incorrect NIC Number and Passport Number
                        will be rejected.</p>
                    <p>Please have your NIC and Passport scanned before you start
                        filling in your application. Enter your NIC number and Passport
                        number to verify if an application is already in process under
                        your name.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <s:textfield name="applicationVO.nic" id="nicNo"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <div class="col-sm-4">
                                <label for="passportNo" class="control-label"><b><span
                                        class="mandatory_field">*</span>Passport No:</b></label>
                            </div>
                            <div class="col-sm-6">
                                <s:textfield name="applicationVO.passport" id="passportNo"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <div class="col-sm-4">
                                <label for="confirmNicNo" class="control-label"><b>Confirm
                                    NIC No:</b></label>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" name="confirmNic" id="confirmNicNo"
                                       class="form-control" value="${applicationVO.nic}"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="confirmPassport" id="confirmPassportNo"
                                       class="form-control" value="${applicationVO.passport}"
                                       autocomplete="off"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <div class="col-sm-4">
                                <label for="newNicNo" class="control-label"><b>New NIC
                                    No:</b></label>
                            </div>
                            <div class="col-sm-6">
                                <s:textfield name="applicationVO.newNic" id="newNicNo"
                            ...
                            <div class="col-sm-6">
                                <c:choose>
                                    <c:when test="${applicationVO.countryId != null}">
                                        <select name="applicationVO.countryId" id="countrySelect"
                                                class="form-control" onchange="getCommissioners();">
                                            <option value="0">Please select</option>
                                            <c:forEach var="country" items="${countryList}">
                                                <c:choose>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <div class="col-sm-4">
                                <label for="confirmNewNicNo" class="control-label"><b>Confirm
                                    New NIC No:</b></label>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" name="confirmNewNic" id="confirmNewNicNo"
                                       class="form-control" value="${applicationVO.newNic}"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <div class="col-sm-4">
                                <label for="countryVerifySelect" class="control-label"><b>Reference
                                    high commission/embassy/consulate:</b></label>
                            </div>
                            <div class="col-sm-6">
                                <c:choose>
                    ...
                    <div id="highCommissionerOtherDetailDiv">
                            ...
                            <div class="form-group">
                                <div class="col-sm-10">
                                    <label for="certificateIndicationAddress" class="control-label"><b><span
                                            class="mandatory_field">*</span>High
                                        Commission/Embassy/Consulate Name (Adressee & the Name of the
                                        Authority):</b></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div class="col-sm-10">
                                    <p>
                                        <i>"e.g. H. E. THE HIGH COMMISSIONER, SRI LANKAN HIGH
                                            COMMISSION"</i>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <s:textfield name="applicationVO.highCommisionReference"
                                             id="highCommisionReferenceName" cssClass="form-control"
                                             autocomplete="off"/>
                            </div>
                        </div>
                        <div style="clear: both;"></div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-10">
                                    <label for="certificateIndicationAddress" class="control-label"><b><span
                                        ...
                                        Commission/Embassy/Consulate to which the certificate should
                                        be addressed to:</b></label>
                                </div>
                            </div>
                        </div>
                        <div style="clear: both;"></div>
                    ...
                    <div class="form-group" id="capchaDivId">
                        <div class="col-sm-3">
                            <span class="mandatory_field">*</span>
                            <s:label for="captcha" cssClass="control-label"
                                     value="Captcha Text"/>
                        </div>
                        <div class="col-sm-6">
                            <table>
                                <tr>
                                    <td><s:textfield cssClass="form-control" name="uword"
                                                     id="uword" size="40" maxLength="100"/></td>
                                    <td><img src="<%=request.getContextPath()%>/Captcha.jpg"
                                             border="1" id="capcha_id" height="20" width="80"/></td>
                                    <td><img style="cursor: hand"
                                             src="<%=request.getContextPath()%>/images/refresh.jpg"
                                             border="0" height="20" width="20" title="Refresh"
                                             onclick="refreashCaptcha()"/></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12" id="verifyButtonDiv">
                        <div style="float: right;">
                            <input type="submit" id="verifySubmitButton"
                                   class="btn btn-primary es-buttton" value="Verify"/>
                        </div>
                    </div>
                    <div style="clear: both;"></div>
            ...
            <div id="verifyMessage">You can submit another application for
                the same country only when your previous application is processed.
            </div>
            ...
            <s:form theme="simple" class="form-horizontal"
                    id="applicationRegistrationForm" role="form" method="post"
                    action="saveApplication.action"
            ...
            <s:hidden name="applicationVO.highCommisionReferenceId"
                      id="highCommisionReferenceId"/>
            <s:hidden name="applicationVO.highCommisionReference"
                      id="highCommisionReference"/>
            <s:hidden name="applicationVO.highCommisionReferenceAddress"
                      id="highCommisionReferenceAddressHidden"/>

            <input type="hidden" id="verificationStatus"
                   name="verificationStatus" value="${verificationStatus}"/>
            <input type="hidden" id="captchaStatus" name="captchaStatus"
                   value="${captchaStatus}"/>
            <input type="hidden" id="reapplyStatus" name="reApplyStatus"
                   value="${reApplyStatus}"/>
            <input type="hidden" id="serverDate"
                   name="serverDate" value="${serverDate}"/>
            <div class="middle_content">

                <div class="col-lg-12">
                    <div class="form-group">
                        <div class="col-sm-3">
                            <label for="nameInFullAsNic" class="control-label"><b>Applicant's
                                Name in full as in the current NIC:</b></label>
                        </div>
                        <div class="col-sm-9">
                            <s:textfield name="applicationVO.applicantNameAsNic"
                                         id="nameInFullAsNic" cssClass="form-control" autocomplete="off"/>
                        </div>
                    </div>
                </div>
                <div style="clear: both;"></div>
                        ...
                        <div class="col-sm-5" style="width: 48.6%">
                            <c:choose>
                                <c:when test="${applicationVO.sex != null}">
                                    <select name="applicationVO.sex" id="sexSelect"
                                            class="form-control">
                                        <c:choose>
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="col-sm-6">
                            <label for="statusSelect" class="control-label"><b><span
                                    class="mandatory_field">*</span>Status</b></label>
                        </div>
                        <div class="col-sm-5" style="width: 48%">
                            <c:choose>
                                <c:when test="${applicationVO.applicantStatus != null}">
                                    <select name="applicationVO.applicantStatus" id="statusSelect"
                                            class="form-control">
                                        <c:forEach var="applicantStatus" items="${applicantStatus}">
                                            <c:choose>
                                                <c:when
                                                        test="${applicationVO.applicantStatus == applicantStatus.value}">
                    ...
                    <div class="form-group">
                        <div class="col-sm-3">
                            <label for="highCommisionReference" class="control-label"><b><span
                                    class="mandatory_field">*</span>Applicant's Name in full as in
                                the Passport:</b></label>
                        </div>
                        <div class="col-sm-9">
                            <s:textfield name="applicationVO.applicantNameAsPassport"
                                         id="nameInFullAsPassport" cssClass="form-control"
                                         autocomplete="off"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <div class="col-sm-3">
                            <label for="highCommisionReference" class="control-label"><b><span
                                    class="mandatory_field">*</span>Which name should be printed in certificate ? :</b></label>
                        </div>
                        <c:choose>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <s:textfield name="passportIssueDate" id="passportIssueDate"
                                     cssClass="form-control" readonly="true"/>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    <div class="col-sm-3">
                        <label for="presentAddressLanka" class="control-label"><b>Present
                            Address in Sri Lanka:</b></label>
                    </div>
                    <div class="col-sm-9">
                        <s:textfield name="applicationVO.presentAddressLocal"
                                     id="presentAddressLanka" cssClass="form-control"
                                     autocomplete="off"/>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    <div class="col-sm-3">
                        <label for="presentAddressOverseas" class="control-label"><b>Present
                            Address (Overseas):</b></label>
                    </div>
                    <div class="col-sm-9">
                        <s:textfield name="applicationVO.presentAddressOverseas"
                                     id="presentAddressOverseas" cssClass="form-control"
                                     autocomplete="off"/>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <s:textfield name="applicationVO.occupation" id="occupation"
                                     cssClass="form-control"/>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <div class="col-sm-6" style="width:51.3%">
                        <label for="purposeSelect" class="control-label"><b><span
                                class="mandatory_field">*</span>Purpose</b></label>
                    </div>
                    <div class="col-sm-5" style="width:48.7%">
                        <c:choose>
                            <c:when test="${applicationVO.purpose != null}">
                                <select name="applicationVO.purpose" id="purposeSelect"
                                        class="form-control">
                                    <c:forEach var="applicationPurpose"
                                               items="${applicationPurposeMap}">
                                        <c:choose>
                                            <c:when
                                                    test="${applicationVO.purpose == applicationPurpose.value}">
                ...
                <div class="form-group">
                    <div class="col-sm-4">
                        <label for="previousCertificateSelect" class="control-label"><b><span
                                class="mandatory_field">*</span>Have you applied for a
                            certificate previously ?</b></label>
                    </div>
                    <div class="col-sm-2">
                        <c:choose>
                            <c:when
                                    test="${applicationVO.previousCertificateApply != null}">
                                <select name="applicationVO.previousCertificateApply"
                                        id="previousCertificateSelect" class="form-control"
                                        onchange="previousCertificateAppliedForm();">
                                    <c:choose>
                                        <c:when
                                                test="${applicationVO.previousCertificateApply == 1}">
                                            <option value="1" selected="selected">Yes</option>
                                            <option value="0">No</option>
                                        </c:when>
                                        <c:when
                                                test="${applicationVO.previousCertificateApply == 0}">
                                            <option value="1">Yes</option>
                                            <option value="0" selected="selected">No</option>
                                        </c:when>
                                    </c:choose>
            ...
            <div id="previousCertificateIssueForm" style="display: none;">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-sm-6">
                            <label for="previousCertificateIssueSelect"
                                   class="control-label"><b>If so, was a certificate
                                issued to you:</b></label>
                        </div>
                        <div class="col-sm-4">
                            <c:choose>
                                <c:when
                                        test="${applicationVO.previousCertificateIssueStatus != null}">
                                    <select name="applicationVO.previousCertificateIssueStatus"
                                        ...
                                        <c:choose>
                                            <c:when
                                                    test="${applicationVO.previousCertificateIssueStatus == 1}">
                                                <option value="1" selected="selected">Yes</option>
                                            </c:when>
                                            <c:otherwise>
                                                <option value="1">Yes</option>
                                        ...
                                        <c:choose>
                                            <c:when
                                                    test="${applicationVO.previousCertificateIssueStatus == 0}">
                                                <option value="0" selected="selected">No</option>
                                            </c:when>
                                            <c:otherwise>
                                                <option value="0">No</option>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-sm-6">
                            <label for="previousCertificateCountrySelect"
                                   class="control-label"><b>Country of the last
                                certificate:</b></label>
                        </div>
                        <div class="col-sm-4">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-sm-6">
                            <label for="lastCertificateReferenceNo" class="control-label"><b>Reference
                                No. of the last certificate:</b></label>
                        </div>
                        <div class="col-sm-4">
                            <s:textfield
                                    name="applicationVO.previousCertificateReferenceNo"
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-sm-6">
                            <label for="lastCertificateIssueDate" class="control-label"><b>Date
                                of Issue:</b></label>
                        </div>
                        <div class="col-sm-4">
                            <s:textfield name="previousCertificateIssueDate"
                                         id="lastCertificateIssueDate" cssClass="form-control"
                                         readonly="true"/>
                        </div>
                    </div>
                </div>
            ...
            <p class="mandatory_field">Note: When mentioning residential addresss and police areas, mention only the
            ...
            <div id="addressFormDiv">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <s:textfield name="" id="certificationAddress"
                                         cssClass="form-control" autocomplete="off"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <div class="col-sm-3">
                            <label for="certificationPoliceAreaSelect"
                                   class="control-label"><b><span
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="col-sm-3">
                            <label for="certificationPoliceAreaFromSelect"
                                   class="control-label"><b><span
                                    class="mandatory_field">*</span>From</b></label>
                        </div>
                        <div class="col-sm-9">
                            <s:textfield name="" id="certificationPoliceAreaFromSelect"
                                         cssClass="form-control" readonly="true"/>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="col-sm-3">
                            ...
                            <label for="certificationPoliceAreaToSelect"
                                   class="control-label"><b><span
                                    class="mandatory_field">*</span>To</b></label>
                        </div>
                        <div class="col-sm-6">
                            <s:textfield name="" id="certificationPoliceAreaToSelect"
                                         cssClass="form-control" readonly="true"/>
                        </div>
                    </div>
                </div>
            ...
            <table border="1" style="width: 100%" id="certificateAddressTable">
                ...
                <c:forEach var="applicantAddress"
                           items="${applicationVO.applicantCertificateAddresses}"
                           varStatus="counter">
                    <tr>
                        <td><input
                                name="certificateAddressList[${counter.index}].address"
                                type="text" readonly="readonly" class="address"
                                value="${applicantAddress.address}"/></td>
                        <td><input
                                name="certificateAddressList[${counter.index}].policeAreaId"
                                type="hidden" readonly="readonly" class="policeAreaVal"
                        ...
                        <td><c:set var="applicationCertificateFromDate">
                            <fmt:formatDate value="${applicantAddress.fromDate}"
                                            pattern="dd/MM/yyyy"/>
                        </c:set> <input
                                name="certificateAddressList[${counter.index}].fromDateStr"
                                type="text" readonly="readonly" class="from"
                                value="${applicationCertificateFromDate}"/></td>
                        <td><c:set var="applicationCertificateToDate">
                            <fmt:formatDate value="${applicantAddress.toDate}"
                                            pattern="dd/MM/yyyy"/>
                        </c:set> <input
                                name="certificateAddressList[${counter.index}].toDateStr"
                                type="text" readonly="readonly" class="to"
                                value="${applicationCertificateToDate}"/></td>
                        <td></td>
                        <td></td>
                    </tr>
                </c:forEach>
            ...
            <div id="authorisedPersonDiv">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <div class="col-sm-6">
                            <label for="handoverPersonSelect" class="control-label"><b>Person
                                authorised by the applicant who are in foreign to handover
                                the application:</b></label>
                        </div>
                        <div class="col-sm-3">
                            <c:choose>
                                <c:when
                                        test="${applicationVO.authorizedHandoverPerson != null}">
                                    <select name="applicationVO.authorizedHandoverPerson"
                                            id="handoverPersonSelect" class="form-control">
                                        <c:forEach var="handOverPerson" items="${handOverPersons}">
                                            <c:choose>
                                                <c:when
                                                        test="${handOverPerson.value == applicationVO.authorizedHandoverPerson}">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <s:textfield name="applicationVO.authorizedHandoverPersonName"
                                         id="handoverPersonName" cssClass="form-control"
                                         autocomplete="off"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <div class="col-sm-2">
                            <label for="handoverPersonNIC" class="control-label"><b>NIC/Passport
                                No:</b></label>
                        </div>
                        <div class="col-sm-3">
                            <s:textfield
                                    name="applicationVO.authorizedHandoverPersonNicPassport"
                                    id="handoverPersonNICPassport" cssClass="form-control"
                                    autocomplete="off"/>
                        </div>
                    </div>
                </div>
            ...
            <p>Indicate the address the police clearance certificate should
                be posted to:</p>

            <p class="mandatory_field">Note : Please enter your correct
                present address. Your certificate will be posted to this address.
                This address cannot be changed.</p>

            <div class="col-lg-12">
                <div class="form-group">
                    <div class="col-sm-2">
                        <label for="addressLineOne" class="control-label"><b><span
                                class="mandatory_field">*</span>Address Line 1:</b></label>
                    </div>
                    <div class="col-sm-10">
                        <s:textfield name="applicationVO.certificatePostAddressLineOne"
                                     id="addressLineOne" cssClass="form-control" autocomplete="off"/>
                    </div>
                </div>
            </div>
            <div style="clear: both;"></div>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    <div class="col-sm-2">
                        <label for="addressLineTwo" class="control-label"><b>Address
                            Line 2:</b></label>
                    </div>
                    <div class="col-sm-10">
                        <s:textfield name="applicationVO.certificatePostAddressLineTwo"
                                     id="addressLineTwo" cssClass="form-control" autocomplete="off"/>
                    </div>
                </div>
            </div>
            <div style="clear: both;"></div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <s:textfield name="applicationVO.certificatePostAddressCity"
                                     id="city" cssClass="form-control" autocomplete="off"/>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <s:textfield name="applicationVO.certificatePostAddressState"
                                     id="state" cssClass="form-control" autocomplete="off"/>
                    </div>
                </div>
            </div>
            <div style="clear: both;"></div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <div class="col-sm-4">
                        <label for="postal" class="control-label"><b>Postal/ZIP
                            Code:</b></label>
                    </div>
                    <div class="col-sm-7">
                        <s:textfield name="applicationVO.certificatePostAddressPostal"
                                     id="postal" cssClass="form-control" autocomplete="off"/>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <c:choose>
                            <c:when
                                    test="${applicationVO.certificatePostAddressCountry != null}">
                                <select name="applicationVO.certificatePostAddressCountry"
                                        id="postalCountrySelect" class="form-control">
                                    <option value="0">Please select</option>
                                    <c:forEach var="country" items="${countryList}">
                                        <c:choose>
                                            <c:when
                                                    test="${applicationVO.certificatePostAddressCountry == country.id}">
                                                <option value="${country.id}"
                                                        selected="selected">${country.countryName}</option>
                                            </c:when>
                                            <c:otherwise>
                    ...
                    <s:hidden id="postalCountrySelectName"
                              name="applicationVO.certificatePostAddressCountryName" value=""/>
                </div>
            </div>
            <div style="clear: both;"></div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <div class="col-sm-4">
                        <label for="postalMobile" class="control-label"><b><span
                                class="mandatory_field">*</span>Mobile Number:</b></label>
                    </div>
                    <div class="col-sm-1">
                            <%--<c:choose>--%>
                            <%--<c:when test="${applicationVO.mobileCountryCodeId != null}">--%>
                            <%--<select name="applicationVO.mobileCountryCodeId"--%>
                            <%--id="mobileCountryCodeId" class="form-control">--%>
                            <%--<c:forEach var="country" items="${countryList}">--%>
                            <%--<c:choose>--%>
                            <%--<c:when--%>
                            <%--test="${applicationVO.nationalityId == country.id}">--%>
                            <%--<option value="${country.id}"--%>
                        ...
                        <s:hidden name="applicationVO.mobileCountryCode" id="mobileCountryCodeSelected"
                                  value="Sri Lanka(+94)"/>
                        <s:hidden name="applicationVO.mobileCountryCodeId" id="mobileCountryCodeSelectedVal"
                                  value="199"/>


                    </div>
                    <div class="col-sm-5" style="width:49.5%;">
                        <s:textfield name="applicationVO.mobileNo" id="postalMobile"
                                     cssClass="form-control" autocomplete="off"/>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <div class="col-sm-4">
                        <label for="postalEmail" class="control-label"><b><span
                                class="mandatory_field">*</span>Email:</b></label>
                    </div>
                    <div class="col-sm-7">
                        <s:textfield name="applicationVO.email" id="postalEmail"
                                     cssClass="form-control" autocomplete="off"/>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                            <%--<c:choose>--%>
                            <%--<c:when test="${applicationVO.mobileCountryCodeId != null}">--%>
                            <%--<select name="mobileCountryCodeConId"--%>
                            <%--id="mobileCountryCodeConId" class="form-control">--%>
                            <%--<c:forEach var="country" items="${countryList}">--%>
                            <%--<c:choose>--%>
                            <%--<c:when--%>
                            <%--test="${applicationVO.nationalityId == country.id}">--%>
                    ...
                    <div class="col-sm-5" style="width:49.5%;">
                        <input type="text" name="postalConfirmMobile"
                               id="postalConfirmMobile" class="form-control"
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <div class="col-sm-4">
                        <label for="postalConfirmEmail" class="control-label"><b><span
                                class="mandatory_field">*</span>Confirm Email:</b></label>
                    </div>
                    <div class="col-sm-7">
                        <input type="text" name="postalConfirmEmail"
                               id="postalConfirmEmail" class="form-control"
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    <div class="col-sm-2">
                        <label for="spouseFullName" class="control-label"><b>Spouse's
                            Full Name:</b></label>
                    </div>
                    <div class="col-sm-10">
                        <s:textfield name="applicationVO.spouseFullName"
                                     id="spouseFullName" cssClass="form-control" autocomplete="off"/>
                    </div>
                </div>
            </div>
            <div style="clear: both;"></div>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <s:textfield name="applicationVO.spouseNationality"
                                     id="spouseNationality" cssClass="form-control"
                                     autocomplete="off"/>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    <div class="col-sm-2">
                        <label for="spousePassport" class="control-label"><b>Passport
                            Number:</b></label>
                    </div>
                    <div class="col-sm-5">
                        <s:textfield name="applicationVO.spousePassport"
                                     id="spousePassport" cssClass="form-control" autocomplete="off"/>
                    </div>
                </div>
            </div>
            <div style="clear: both;"></div>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    <div class="col-sm-2">
                        <label for="spouseNic" class="control-label"><b>NIC
                            Number:</b></label>
                    </div>
                    <div class="col-sm-5">
            ...
            <div style="clear: both;"></div>
                ...
                <%--<div class="form-group">--%>
                <%--<div class="col-sm-2">--%>
                <%--<label for="modeOfPayment" class="control-label"><b>Mode--%>
                <%--of Payment:</b></label>--%>
                <%--</div>--%>
                <%--<div class="col-sm-5">--%>
                <%--<c:choose>--%>
                <%--<c:when test="${transactionVO.paymentMode != null}">--%>
                <%--<select name="transactionVO.paymentMode"--%>
                <%--id="paymentModeSelect" class="form-control"--%>
                <%--onchange="manualPaymentFormValidation();">--%>
                <%--<c:choose>--%>
                ...
                <%--<option value="CASH">Cash</option>--%>
                <%--<option value="CHEQ">Cheque</option>--%>
                <%--<option value="WIRE" selected="selected">Wire--%>
                <%--Transfer--%>
                <%--</option>--%>
                <%--</c:when>--%>
                <%--</c:choose>--%>
                ...
                <%--<div class="form-group">--%>
                <%--<div class="col-sm-2">--%>
                <%--<label for="totalFee" class="control-label"><b><span--%>
                <%--class="mandatory_field">*</span>Amount:</b></label>--%>
                <%--</div>--%>
                <%--<div class="col-sm-5">--%>
                <%--<s:textfield name="transactionVO.totalFee" id="totalFee"--%>
                <%--cssClass="form-control" autocomplete="off"/>--%>
                <%--</div>--%>
                <%--</div>--%>
                <%--</div>--%>
                ...
                <%--<div class="form-group">--%>
                <%--<div class="col-sm-2">--%>
                <%--<label for="chequeNo" class="control-label"><b>Cheque--%>
                <%--No:</b></label>--%>
                <%--</div>--%>
                <%--<div class="col-sm-5">--%>
                <%--<s:textfield name="transactionVO.chequeNo" id="chequeNo"--%>
                <%--cssClass="form-control" autocomplete="off"/>--%>
                <%--</div>--%>
                <%--</div>--%>
                <%--</div>--%>
                ...
                <%--<div class="form-group">--%>
                <%--<div class="col-sm-2">--%>
                <%--<label for="accountNo" class="control-label"><b>Account--%>
                <%--No:</b></label>--%>
                <%--</div>--%>
                <%--<div class="col-sm-5">--%>
                <%--<s:textfield name="transactionVO.accountNo" id="accountNo"--%>
                <%--cssClass="form-control" autocomplete="off"/>--%>
                <%--</div>--%>
                <%--</div>--%>
                <%--</div>--%>
                ...
                <%--<div class="form-group">--%>
                <%--<div class="col-sm-2">--%>
                <%--<label for="accountHolderName" class="control-label"><b>Account--%>
                <%--Holder's Name:</b></label>--%>
                <%--</div>--%>
                <%--<div class="col-sm-5">--%>
                <%--<s:textfield name="transactionVO.accountHolderName"--%>
                <%--id="accountHolderName" cssClass="form-control"--%>
                <%--autocomplete="off"/>--%>
                <%--</div>--%>
                <%--</div>--%>
                <%--</div>--%>
                ...
                <%--<div class="form-group">--%>
                <%--<div class="col-sm-2">--%>
                <%--<label for="bookReceiptNo" class="control-label"><b>Book--%>
                <%--Receipt No:</b></label>--%>
                <%--</div>--%>
                <%--<div class="col-sm-5">--%>
                <%--<s:textfield name="transactionVO.bookReceiptNo"--%>
                <%--id="bookReceiptNo" cssClass="form-control" autocomplete="off"/>--%>
                <%--</div>--%>
                <%--</div>--%>
                <%--</div>--%>
                <%--<div style="clear: both;"></div>--%>
            ...
            <div id="uploadFormDiv">
                    ...
                    <div class="form-group">
                        <div class="col-sm-3">
                            <label for="passportUploadPath" class="control-label"><b><span
                                    class="mandatory_field">*</span>Passport - Personal detail
                                page: <i>(Maximum file size is 250 Kb)</i></b></label>
                        </div>
                        <div class="col-sm-3">
                            <input id="passportFileUpload" name="passportFileUpload"
                                   type="file" style=""/>
                            <s:hidden name="applicationVO.passportAttachPath"
                                      id="passportUploadPath" cssClass="form-control"/>
                        </div>
                        <div class="col-sm-2">
                            <input type="button" onclick="uploadFile('pas');"
                                   class="btn btn-primary es-buttton" value="Upload"/> <img
                                src="images/ajax-loader.gif" id="ajax_loader_passport"
                                style="display: none;"/> <img src="images/right_green.jpg"
                                                              id="upload_complete_passport" style="display: none;"/>
                        </div>
                        <c:if test="${reApplyStatus == 1}">
                            <div class="col-sm-1">
                                <c:if test="${applicationVO.passportAttachPath != ''}">
                                    <a
                                            href="policeFileFinder.htm?fileName=${applicationVO.passportAttachPath}"
                ...
                <div class="col-lg-12" style="margin: 1px 0px">
                    <div class="form-group">
                        <div class="col-sm-3">
                            <label for="passportUploadPath" class="control-label"><b><span
                                    class="mandatory_field">*</span>Passport - Countries allowed
                                page: <i>(Maximum file size is 250 Kb)</i></b></label>
                        </div>
                        <div class="col-sm-3">
                            <input id="passportFileUploadBack"
                                   name="passportFileUploadBack" type="file" style=""/>
                            <s:hidden name="applicationVO.passportBackAttachPath"
                                      id="passportUploadPathBack" cssClass="form-control"/>
                        </div>
                        <div class="col-sm-2">
                            <input type="button" onclick="uploadFile('pas_back');"
                                   class="btn btn-primary es-buttton" value="Upload"/> <img
                                src="images/ajax-loader.gif" id="ajax_loader_passport_back"
                                style="display: none;"/> <img src="images/right_green.jpg"
                        ...
                        <c:if test="${reApplyStatus == 1}">
                            <div class="col-sm-1">
                                <c:if test="${applicationVO.passportBackAttachPath != ''}">
                                    <a
                                            href="policeFileFinder.htm?fileName=${applicationVO.passportBackAttachPath}"
                                            target="_blank"><img src="images/open.png" height="25px"/></a>
                                </c:if>
                            </div>
                        </c:if>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <label class="col-sm-12 mandatory_field">
                            (Note: Upload both Personal detail page and countries allowed page.)</label>
                    </div>
                </div>
                <div style="clear: both;"></div>
                ...
                <div>
                    ...
                    <div class="col-lg-12">
                        <label class="col-sm-12 mandatory_field">
                            (Note: Both sides.) Non-Sri Lankan provide NIC if availble to avoid processing
                            delays.</label>
                    </div>
                ...
                <div class="col-lg-12" style="margin: 1px 0px">
                    <div class="form-group">
                        <div class="col-sm-3">
                            <label for="birthCertificateUpload" class="control-label"><b>Birth
                                Certificate - front side:<i>(Maximum file size is 250 Kb)</i>
                            </b></label>
                        </div>
                        <div class="col-sm-3">
                            <input id="birthCertificateUpload"
                                   name="birthCertificateUpload" type="file" style=""/>
                            <s:hidden name="applicationVO.birthCertificatePath"
                                      id="birthCertificateUploadPath" cssClass="form-control"/>
                        </div>
                        <div class="col-sm-2">
                            <input type="button" onclick="uploadFile('bir');"
                                   class="btn btn-primary es-buttton" value="Upload"/> <img
                                src="images/ajax-loader.gif"
                                id="ajax_loader_birth_certificate" style="display: none;"/> <img
                                src="images/right_green.jpg"
                                id="upload_complete_birth_certificate" style="display: none;"/>
                        </div>
                        <c:if test="${reApplyStatus == 1}">
                            <div class="col-sm-1">
                                <c:if test="${applicationVO.birthCertificatePath != ''}">
                                    <a
                                            href="policeFileFinder.htm?fileName=${applicationVO.birthCertificatePath}"
                                            target="_blank"><img src="images/open.png" height="25px"/></a>
                                </c:if>
                            </div>
                        </c:if>
                ...
                <div class="col-lg-12" style="margin: 1px 0px">
                    <div class="form-group">
                        <div class="col-sm-3">
                            <label for="birthCertificateUploadBack" class="control-label"><b>Birth
                                Certificate - back side:<i>(Maximum file size is 250 Kb)</i>
                            </b></label>
                        </div>
                        <div class="col-sm-3">
                            <input id="birthCertificateUploadBack"
                                   name="birthCertificateUploadBack" type="file" style=""/>
                        ...
                        <div class="col-sm-2">
                            <input type="button" onclick="uploadFile('bir_back');"
                                   class="btn btn-primary es-buttton" value="Upload"/> <img
                                src="images/ajax-loader.gif"
                                id="ajax_loader_birth_certificate_back" style="display: none;"/>
                            <img src="images/right_green.jpg"
                                 id="upload_complete_birth_certificate_back"
                                 style="display: none;"/>
                        </div>
                        <c:if test="${reApplyStatus == 1}">
                            <div class="col-sm-1">
                                <c:if test="${applicationVO.birthCertificateBackPath != ''}">
                                    <a
                                            href="policeFileFinder.htm?fileName=${applicationVO.birthCertificateBackPath}"
                                            target="_blank"><img src="images/open.png" height="25px"/></a>
                                </c:if>
                            </div>
                        </c:if>
                ...
                <div class="col-lg-12">
                    <label class="col-sm-12 mandatory_field">(Note :
                        Sri Lankan citizen below 18. Both sides.)</label>
                </div>
                <div style="clear: both;"></div>
                ...
                <div id="affidavitDivId">
                    ...
                    <div class="col-lg-12" id="affidavitNoteId">
                        ...
                        <label class="col-sm-12 mandatory_field">(Note : Sri Lankan
                            citizen only. The affidavit is mandatory only when the name as in the passport need to be
                            printed on the certificate.)</label>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-8">
                            <label for="referredThroughBereau" class="control-label"><b><span
                                    class="mandatory_field">*</span>Are you referred applicant
                                through the Sri Lankan Foreign Employment Bureau(SLBFE)?</b></label>
                        </div>
                        <div class="col-sm-4">
                            <c:choose>
                                <c:when test="${applicationVO.referredThroughBereau != null}">
                                    <select name="applicationVO.referredThroughBereau"
                                            id="referredThroughBereau" class="form-control"
                                            onchange="setVisibleLetterOfReferenceUpload();">
                                        <c:choose>
                ...
                <div id="letterOfReferenceUploadDiv">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="col-sm-3">
                                <label for="uploadLetterOfReferenceUpload"
                                       class="control-label"><b>If Yes, letter of
                                    reference from SLBFE:<i>(Maximum file size is 250 Kb)</i>
                                </b></label>
                            </div>
                            <div class="col-sm-3">
                                <input id="uploadLetterOfReferenceUpload"
                                       name="uploadLetterOfReference" type="file" style=""/>
                                <s:hidden name="applicationVO.letterOfReferencePath"
                                          id="uploadLetterOfReferencePath" cssClass="form-control"/>
                            </div>
                            <div class="col-sm-2">
                                <input type="button" onclick="uploadFile('let');"
                                       class="btn btn-primary es-buttton" value="Upload"/> <img
                                    src="images/ajax-loader.gif"
                                    id="ajax_loader_letter_of_reference" style="display: none;"/>
                                <img src="images/right_green.jpg"
                                     id="upload_complete_letter_of_reference"
                                     style="display: none;"/>
                            </div>
                            <c:if test="${reApplyStatus == 1}">
                                <div class="col-sm-1">
                                    <c:if test="${applicationVO.letterOfReferencePath != ''}">
                                        <a
                                                href="policeFileFinder.htm?fileName=${applicationVO.letterOfReferencePath}"
                                                target="_blank"><img src="images/open.png"
                                                                     height="25px"/></a>
                                    </c:if>
                                </div>
                            </c:if>
                ...
                <p>Please ensure correct and clear copies of the documents are
                    attached to avoid delays and application rejection.</p>
            ...
            <table>
                <tr>
                    <td style="vertical-align: middle; width: 50px;"><input
                            type="checkbox" name="" id="acceptTermsCheck"
                            class="form-control" onclick="submitButtonStatus();"/></td>
                    <td style="vertical-align: middle;"><p>
                        <span class="mandatory_field">*</span>I declare that the
                        information provided above are true to the best of my knowledge
                        and I agree to the terms of Sri Lankan Police Headquarters.
                    </p></td>
                </tr>
            </table>
            ...
            <div class="col-lg-12">
                <div style="float: right;">
                    <input id="saveApplicationSubmitButton" type="submit"
                           class="btn btn-primary es-buttton" value="Submit"/> <input
                        type="button" class="btn btn-primary es-buttton" value="Reset"
                        onclick="resetForm();"/>
                </div>
            </div>
            <div style="clear: both;"></div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var postalCountry = $(
                    "#postalCountrySelect").val();
                if (postalCountry != 0) {
                    var postalCountryName = $(
                        "#postalCountrySelect option:selected")
                        .text();
                ...
                var countryName = $(
                    "#countryVerifySelect option:selected")
                    .text();
                $("#countryVerifySelectName").val(
                    countryName);

                var previousCertificateCountryName = $(
                    "#previousCertificateCountrySelect option:selected")
                    .text();
                $("#previousCertificateCountryName").val(
                    previousCertificateCountryName);

                verificationValidator();
                reApplyStatus();
                hideModeOfPayment();
                hideAuthorisedPerson();
                ...
                $('#newNic').attr('maxlenth', '12');
                $('#confirmNewNicNo').attr('maxlenth', '12');
            ...
            function validateCitizenOfUser() {
                ...
                if (selectedOption == '1') {
                    ...
                    alert(msg);
                    $('#verifySubmitButton').prop('disabled', true);
                    $('#saveApplicationSubmitButton').prop('disabled', true);
                    $('#acceptTermsCheck').prop('disabled', true);
                    return false;
                } else {
            ...
            function verificationValidator() {
                if ($("#verificationStatus").val() == 1) {
                    ...
                    $("#highCommisionReferenceName").attr("readonly",
                        "true");
                    $("#highCommisionReferenceAddress").attr("readonly",
                        "true");
            ...
            function hideAuthorisedPerson() {
                $("#authorisedPersonDiv").hide();
            }
            ...
            function initializeDateTimePickers() {
                $('#certificationPoliceAreaFromSelect').datepicker({
                        ...
                        changeMonth: true,
//                         maxDate: "+0d",
                        maxDate: ($.datepicker.parseDate('dd/mm/yy',
                            $("#serverDate").val())),
                        minDate: ($.datepicker.parseDate('dd/mm/yy',
                            $("#dateOfBirth").val())),
                        dateFormat: "dd/mm/yy",
                        onClose: function (selectedDate) {
                            ...
                            $("#certificationPoliceAreaToSelect")
...
//                             maxDate: "+0d",
                            ...
                            minDate: ($.datepicker.parseDate(
                                'dd/mm/yy', $("#dateOfBirth")
                                    .val())),
                            dateFormat: "dd/mm/yy",
                            onClose: function (selectedDate) {
                                if (!(selectedDate == "")) {
                                    $(
                                        "#certificationPoliceAreaFromSelect")
                                        .datepicker("option",
                                            "maxDate",
                                            selectedDate);
                                } else {
...
//                                             new Date());
                                ...
                                if (!(selectedDate == "")) {
                                    $("#passportIssueDate")
                                        .datepicker("option",
                                            "minDate",
                                            selectedDate);
                                    $("#dateOfcitizenshipObtained")
                                        .datepicker("option",
                                            "minDate",
                                            selectedDate);
                                    $("#lastCertificateIssueDate")
                                        .datepicker("option",
                                            "minDate",
                                            selectedDate);
                                }
            ...
            function previousAppRefNoForm() {
                ...
                if (status == 'new') {
                    ...
                    $("#previousReferenceNo").val(
                        $("#applicationReferenceNoValue").val());
            ...
            function addRowToCertificateAddressTable() {
                ...
                var policeAreaName = $(
                    "#certificationPoliceAreaSelect option:selected")
                    .text();
                ...
                var rowCountSaved = parseInt($('#hiddenPoliceAddressRowId')
                    .val());
                if (rowCountSaved < 0) {
                ...
                if ($(".appendedRowAddress").length) {
                    blockUI();
                    $(".appendedRowAddress").each(
                        function (index) {
                            var rowId = $(this).attr('id');
                            var rowCountNumber = $.trim(rowId.replace(
                                "cad", ""));

                            var fromDateId = 'addedFromDate_'
                                + rowCountNumber;
                            var toDateId = 'addedToDate_'
                                + rowCountNumber;
                            var policeAreaIdId = 'addedPoliceArea_'
                                + rowCountNumber;
                            var selectedAddressId = 'addedAddress_'
                                + rowCountNumber;
                            ...
                            var policeAr = $.trim($(
                                '#' + policeAreaIdId).val());
                            var selectedAdrs = $.trim($(
                                '#' + selectedAddressId).val());

                            myArray.push(new DateValidationVO(
                                selectedAdrs, policeAr, fromDt,
                                toDt));
                        });

                    ///add newly added date
                    myArray.push(new DateValidationVO(address,
                        policeAreaName, from, to));
                            ...
                            function (response) {
                                ...
                                if (response.addressPeriodValidStatus != 1) {
                                    ...
                                    $(
                                        "#certificationPoliceAreaToSelect")
                                        .val('');
                                    $('#hiddenPoliceAddressRowId')
                                        .val(-1);

                                    $("#certificateAddressTable")
                                        .append(
                                            '<tr id="cad' + rowCount + '" class="appendedRowAddress">'
                                            + '<td><input name="certificateAddressList[' + rowCount + '].address" id="addedAddess_' + rowCount + '" type="text" readonly="readonly" class="address" value="' + address + '" /></td>'
                                            + '<td><input name="certificateAddressList[' + rowCount + '].policeAreaId" id="addedPoliceArea_' + rowCount + '" type="hidden" readonly="readonly" class="policeAreaVal" value="' + policeArea + '" /><input type="text" name="certificateAddressList[' + rowCount + '].policeArea" readonly="readonly" class="policeArea" value="' + policeAreaName + '" /></td>'
                                            ...
                                            + '<td><img class="remRow" src="images/edit.png" onclick="editCertificateAddressRow(\'cad'
                                            + rowCount
                                            + '\');"></td>'
...
//                         "option", "maxDate", new Date());
                    $("#certificationPoliceAreaFromSelect").datepicker(
                        "option", "maxDate", $.datepicker.parseDate('dd/mm/yy',
                            $("#serverDate").val()));
            ...
            function editCertificateAddressRow(rowId) {
                $("#certificationAddress").val(
                    $("#certificateAddressTable").find('#' + rowId)
                        .find('.address').val());
                $("#certificationPoliceAreaSelect").val(
                    $("#certificateAddressTable").find('#' + rowId)
                        .find('.policeAreaVal').val());
                $("#certificationPoliceAreaFromSelect").val(
                    $("#certificateAddressTable").find('#' + rowId)
                        .find('.from').val());
                $("#certificationPoliceAreaToSelect").val(
            ...
            function validateVerificationForm() {
                try {
                    ...
                    if (dateOfBirth != '' && dateOfObtained != '') {
                        ageWhenMigrate = getAgeOnTwoDate($("#dateOfBirth")
                            .datepicker("getDate"), $(
                            "#dateOfcitizenshipObtained").datepicker(
                            "getDate"));
                    }
                    ...
                    var confirmPassport = $("#confirmPassportNo").val();
                    var countryId = $("#countrySelect").val();

                    var consultantName = $("#highCommisionReferenceName")
                        .val();
...
//                                var newNicLength = newNic.length;
                    ...
                    if (checkBoxVal == '0') {
                        if (citizenOfSriLanka == 1) {
                            if (nationalityId == 199 && age >= 18 && (nic == '' && newNic == '')) {
            ...
            function setHiddenFieldValues() {
                ...
                $("#nationalityIdVerify")
                    .val($("#nationalitySelect").val());
                $("#nationalityVerify").val(
                    $("#nationalitySelect option:selected").text());
                ...
                $("#citizenOfSriLankaVerify").val(
                    $("#citizenOfSriLankaSelect").val());
                $("#citizenOfSriLanka").val(
                    $("#citizenOfSriLankaSelect").val());

                $("#citizenshipObtainedDateVerify").val(
                    $("#dateOfcitizenshipObtained").val());
                $("#citizenshipObtainedDate").val(
                    $("#dateOfcitizenshipObtained").val());
                ...
                $("#highCommissionVerifySelectedValue").val(
                    $("#highCommissionVerifySelect option:selected")
                        .text());
                $("#highCommisionReferenceId").val(
                    $("#highCommissionVerifySelect").val());
                //$("#highCommisionReference").val($("#highCommissionVerifySelect option:selected").text());
                $("#highCommisionReference").val(
                    $("#highCommisionReferenceName").val());
                $("#highCommisionReferenceAddressHidden").val(
                    $("#highCommisionReferenceAddress").val());
            ...
            function submitButtonStatus() {
                if ($("#acceptTermsCheck").is(":checked")) {
                    $("#saveApplicationSubmitButton")
                        .removeAttr('disabled');
                } else {
                    $("#saveApplicationSubmitButton").attr('disabled',
                        'disabled');
                }
            }
            ...
            function validateApplicationForm() {
                try {
                    ...
                    var applicantNameInFullAsNic = $("#nameInFullAsNic")
                        .val();
                    var applicantNameInFullAsPass = $(
                        "#nameInFullAsPassport").val();

                    var nationalityId = $("#nationalitySelect").val();
                    var dateOfBirth = $("#dateOfBirth").val();
                    var age = $("#applicantAge").val();
                    var citizenOfSriLanka = $("#citizenOfSriLankaSelect")
                        .val();
                    var dateOfObtained = $("#dateOfcitizenshipObtained")
                        .val();
                    ...
                    if (nationalityId == 199 && age >= 18
                        && applicantNameInFullAsNic == '') {
                        alert("Applicant's Name is empty");
                        $("#nameInFull").focus();
                        addRedBorder("nameInFull");
                        return false;
                    } else if (citizenOfSriLanka == 1
                        && ageWhenMigrate >= 18
                        && applicantNameInFullAsNic == '') {
                        alert("Applicant's Name is empty");
                        $("#nameInFull").focus();
                        addRedBorder("nameInFull");
                        return false;
                    } else if (applicantNameInFullAsPass == '') {
                        alert("Applicant's Name is empty");
                        $("#nameInFull").focus();
                        addRedBorder("nameInFull");
                        return false;
                    ...
                    var previousCertificate = $(
                        "#previousCertificateSelect").val();
                    var certificateIssueStatus = $(
                        "#previousCertificateIssueSelect").val();
                    var lastCertificateReferenceNo = $(
                        "#lastCertificateReferenceNo").val();
                    ...
                    var presentAddressSriLanka = $("#presentAddressLanka")
                        .val();
                    var presentAddressOverseas = $(
                        "#presentAddressOverseas").val();
                    if (presentAddressSriLanka == ''
                        && presentAddressOverseas == '') {
                    ...
                    var highCommissionIndicateAddress = $(
                        "#certificateIndicationAddress").val();
                    ...
                    var passportAttachBack = $("#passportUploadPathBack")
                        .val();
                    ...
                    var birthCertificateAttach = $(
                        "#birthCertificateUpload").val();
                    var birthCertificateAttachBack = $(
                        "#birthCertificateUploadBack").val();
                    var letterOfReferenceAttach = $(
                        "#uploadLetterOfReferenceUpload").val();
                    var referredThroughBereau = $("#referredThroughBereau")
                        .val();
                    ...
                    var genuineAge = getAge($("#dateOfBirth").datepicker(
                        "getDate"));
                    var ageWhenMigrate = getAgeOnTwoDate($("#dateOfBirth")
                        .datepicker("getDate"), $(
                        "#dateOfcitizenshipObtained").datepicker(
                        "getDate"));
...
//
                    if (selectedOption == 'none') {
                        alert('Please select one of name option.');
                        $('#selectedName').focus();
...
//                    alert('Error :- ' + e)
            ...
            function setApplicationHiddenValues() {
                ...
                if (postalCountry != 0) {
                    var postalCountryName = $(
                        "#postalCountrySelect option:selected").text();
            ...
            function uploadFile(fileType) {
                ...
                if (fileType == 'nic') {
                    ...
                    fileNicPathBack = document
                        .getElementById('nicFileUploadBack').value;
                    nicExtensionBack = fileNicPathBack.split(".").pop()
                        .trim();
                    if (!validateFileUpload('Nic', fileNicPathBack,
                            nicExtensionBack, nicFileBack)) {
                    ...
                    filePassportPath = document
                        .getElementById('passportFileUpload').value;
                    passportExtension = filePassportPath.split(".").pop()
                        .trim();
                    if (!validateFileUpload('Passport', filePassportPath,
                            passportExtension, passportFile)) {
                    ...
                    filePassportPathBack = document
                        .getElementById('passportFileUploadBack').value;
                    passportExtensionBack = filePassportPathBack.split(".")
                        .pop().trim();
                    if (!validateFileUpload('Passport',
                            filePassportPathBack, passportExtensionBack,
                            passportFileBack)) {
                    ...
                    fileBirthCertificatePath = document
                        .getElementById('birthCertificateUpload').value;
                    birthCertificateExtension = fileBirthCertificatePath
                        .split(".").pop().trim();
                    if (!validateFileUpload('Birth Certificate',
                            fileBirthCertificatePath,
                    ...
                    fileBirthCertificatePathBack = document
                        .getElementById('birthCertificateUploadBack').value;
                    birthCertificateExtensionBack = fileBirthCertificatePathBack
                        .split(".").pop().trim();
                    if (!validateFileUpload('Birth Certificate',
                            fileBirthCertificatePathBack,
                            birthCertificateExtensionBack,
                            birthCertificateFileBack)) {
                    ...
                    fileLetterOfReferencePath = document
                        .getElementById('uploadLetterOfReferenceUpload').value;
                    letterOfReferenceExtension = fileLetterOfReferencePath
                        .split(".").pop().trim();
                    if (!validateFileUpload('Letter of Reference',
                            fileLetterOfReferencePath,
                            letterOfReferenceExtension,
            ...
            function validateFileUpload(uploadingFile, path, extension,
                                        file) {
                var maximumFileLimit = parseFloat($('#maximumFileLimit')
                    .val());
                if (path == '') {
                    alert("please select a file before upload for "
                        + uploadingFile);
                    return false;
            ...
            function reApplyOperation() {
                ...
                $("#newNicFileUpload").attr("readonly", "true");
                $("#newNicFileUploadBack").attr("readonly", "true");
                        ...
                        success: function (data) {
                            ...
                            for (var key in data.highCommissionList) {
                                if (commisionerId == data.highCommissionList[key].id) {
                                    $el
                                        .append("<option selected='selected' value=" + data.highCommissionList[key].id + ">"
                                            + data.highCommissionList[key].commissionEmbassyConsultantName
                                            + " - "
                                            + data.highCommissionList[key].commissionEmbassyConsultantAddress
                                            + "</option>");
                                } else {
                                    $el
                                        .append("<option value=" + data.highCommissionList[key].id + ">"
                                            + data.highCommissionList[key].commissionEmbassyConsultantName
                                            + " - "
                                            + data.highCommissionList[key].commissionEmbassyConsultantAddress
                                            + "</option>");
                            ...
                            if (commisionerId == 0) {
                                $el
                                    .append("<option selected='selected' value=\"0\">Other</option>");
...
//                                $("#highCommisionReferenceAddress").val('');
                                ...
                                getSelectedCommissioner();
                                $el
                                    .append("<option value=\"0\">Other</option>");
                            }
                ...
                if (selectedVal == "0") {
                    ...
                    $
                        .ajax({
                            ...
                            data: {
                                commissionerId: selectedVal
                            },
                            dataType: "json",
                            success: function (data) {
                                $("#highCommisionReferenceName")
                                    .val(
                                        data.commissionerVO.addressee
                                        + ","
                                        + data.commissionerVO.commissionEmbassyConsultantName);
                                $("#highCommisionReferenceAddress")
                                    .val(
                                        data.commissionerVO.commissionEmbassyConsultantAddress);
                            }
                        });
                }
            }
            ...
            function previousCertificateIssue() {
                var issueStatus = $("#previousCertificateIssueSelect")
                    .val();
                if (issueStatus == 1) {
                    $("#lastCertificateReferenceNo")
                        .attr('readonly', false);
                    $("#lastCertificateIssueDate").attr('readonly', false);
                    $('#lastCertificateIssueDate').datepicker({
                        changeYear: true,
                        yearRange: "-120:+0",
                        changeMonth: true,
                    ...
                    $("#lastCertificateReferenceNo").attr('readonly', true);
                    $("#lastCertificateIssueDate").attr('readonly', true);
