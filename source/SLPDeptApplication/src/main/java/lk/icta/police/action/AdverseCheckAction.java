...
import lk.icta.police.business.AdverseCheckBusiness;
...
public class AdverseCheckAction extends ActionSupport implements SessionAware {

  private static final long serialVersionUID = 1L;
  private static final Logger LOGGER = Logger.getLogger(AdverseCheckAction.class);
  ...
  public String viewAdverseCheck() {
    if (getUserTypeFromSession() == PoliceEnumConstant.UserType.CA.getCode()) {
      ...
      applicationList = AdverseCheckBusiness.getInstance().searchApplication(searchCriteriaVO, userId);
  ...
  public String searchAdverseCheck() {
    if (getUserTypeFromSession() == PoliceEnumConstant.UserType.CA.getCode()) {
      initializeSearchCriteria();
      clearenceStatusList = PoliceEnumConstant.ApplicationClearenceStatus.getApplicationClearenceStatusMap();
      int userId = getUserIdFromSession();
  ...
  public String updateCertificateIssuanceAd() {
  ...
  public String updateNicrevisionClearenceAd() {
    LOGGER.info("updateClearenceStatus :" + updateClearenceStatus);
