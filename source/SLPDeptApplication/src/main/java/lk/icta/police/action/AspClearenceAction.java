...
import lk.icta.police.business.AspClearenceBusiness;
...
public class AspClearenceAction extends ActionSupport implements SessionAware {

  private static final long serialVersionUID = 1L;
  private static final Logger LOGGER = Logger.getLogger(AspClearenceAction.class);
  ...
  public String viewAspClearence() {
    if (getUserTypeFromSession() == PoliceEnumConstant.UserType.AS.getCode()) {
      initializeSearchCriteria();

      clearenceStatusList = PoliceEnumConstant.ApplicationClearenceStatus.getApplicationClearenceStatusMap();
      int userId = getUserIdFromSession();

      applicationList = AspClearenceBusiness.getInstance().searchApplications(searchCriteriaVO, userId);
  ...
  public String searchAspClearence() {
    if (getUserTypeFromSession() == PoliceEnumConstant.UserType.AS.getCode()) {
      initializeSearchCriteria();
      clearenceStatusList = PoliceEnumConstant.ApplicationClearenceStatus.getApplicationClearenceStatusMap();
      int userId = getUserIdFromSession();
  ...
  public String updateCertificateIssuanceAsp() {
