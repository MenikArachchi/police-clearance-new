...
<title>Print Clearance List</title>
...
<body id="bd" >
	...
	<jsp:include page="../common/header.jsp" /> 
		...
		<div id="es-content"> 
			...
			<c:set var="pageTitle"><s:text name="Print Clearance List"></s:text></c:set>
							...
							<tr>
								<td>
									<c:if test="${sessionScope.ASSIGNED_SERVICE_ID_MAP.containsValue('Review Application')}"> 
										<a href="viewPrintList.action" id="view_print_list">&lt;&lt; Back</a>
									</c:if>
								</td>
							</tr>
							<tr>
