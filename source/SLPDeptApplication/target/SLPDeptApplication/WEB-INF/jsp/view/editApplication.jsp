...
<s:i18n name="lk.icta.resources.global">
    ...
    <div id="es-container" class="container">
        ...
        <div id="es-content">
            ...
            <c:set var="pageTitle">Edit Application</c:set>
            ...
            <s:form theme="simple" class="form-horizontal" id="applicationRegistrationForm" role="form" method="post"
                    action="updateApplication.action" onsubmit="return validateApplicationForm()">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="hidden" value="${applicationVO.nationalityId}"
                                   id="previousSelectedNationality"/>
            ...
            <div class="middle_content">
                ...
                <div id="uploadFormDiv">
                    ...
                    <div class="col-lg-12" style="margin:1px 0px">
                        <div class="form-group">
                            <div class="col-sm-3">
                                <label for="newNicUploadPath" class="control-label"><b>New NIC front side:<i>(Maximum
                                    file size
                                    is 250 Kb)</i></b></label>
                            </div>
                            <div class="col-sm-3">
                    ...
                    <div class="col-lg-12" style="margin:1px 0px">
                        <div class="form-group">
                            <div class="col-sm-3">
                                <label for="newNicUploadPathBack" class="control-label"><b>New NIC back side:<i>(Maximum
                                    file
                                    size is 250 Kb)</i></b></label>
                            </div>
                            <div class="col-sm-3">
                    ...
                    <div class="col-lg-12" style="margin:1px 0px" id="affidavitUploadId">
                        <div class="form-group">
                            <div class="col-sm-3">
                                <label for="affidavitUpload" class="control-label"><b>Affidavit:<i>(Maximum file size is
                                    250 Kb)</i></b></label>
                            </div>
                            <div class="col-sm-3">
                                <input id="affidavitUpload" name="affidavitUpload" type="file" style=""/>
                                <s:hidden name="applicationVO.affidavitAttachPath" id="affidavitUploadPath"
                                          cssClass="form-control"/>
                            </div>
                            <div class="col-sm-2">
                                <input type="button" onclick="uploadFile('affidavit');"
                                       class="btn btn-primary es-buttton" value="Upload"/>
                                <img src="images/ajax-loader.gif" id="ajax_loader_affidavit" style="display:none;"/>
                                <img src="images/right_green.jpg" id="upload_complete_affidavit" style="display:none;"/>
                            </div>
                                ...
                                <c:choose>
                                    <c:when test="${!empty applicationVO.affidavitAttachPath}">
                                        <a href="policeFileFinder.htm?fileName=${applicationVO.affidavitAttachPath}"
                                           target="_blank">
                                            <img src="images/open.png" height="25px"/></a>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    ...
                    window.previousNationality = $('#previousSelectedNationality').val();
...
//                        }
                        ...
                        if ((citizenSriLanka == '1' || nationality == 199) && genuineAge >= 18) {
...
//                            alert(previousNameOption.toLowerCase()+" : "+currentOption);
...
//                                ('#newNicBackRemove').remove();
                        ...
                        var previousNational = window.previousNationality;
//                        if(previousNational !=  nationality){
//                            if(!(currentNicNo == null || currentNicNo =='')){
//                                if (!$('#upload_complete_nic').is(':visible')) {
//                                    alert("Please upload the front side of the current NIC");
//                                    $("#nicUpload").focus();
...
//                    $("#mobileCountryCodeSelected").val($("#mobileCountryCodeId option:selected").text());
                ...
                function uploadFile(fileType) {
                    ...
                    if (fileType == 'nic') {
                        ...
                        fileNewNicPath = document.getElementById('newNicFileUpload').value;
                        newNicExtension = fileNewNicPath.split(".").pop().trim();
                        if (!validateFileUpload('New Nic', fileNewNicPath, newNicExtension, newNicFile)) {
                        ...
                        fileNicPathBack = document.getElementById('newNicFileUploadBack').value;
                        newNicExtensionBack = fileNicPathBack.split(".").pop().trim();
                        if (!validateFileUpload('New Nic Back', fileNicPathBack, newNicExtensionBack, newNicFileBack)) {
                        ...
                        afiidavitPath = document.getElementById('affidavitUpload').value;
                        affidavitExtension = afiidavitPath.split(".").pop().trim();
                        if (!validateFileUpload('Affidavit', afiidavitPath, affidavitExtension, affidavitFile)) {
                        ...
                        if (xhr.readyState == 4 && xhr.status == 200) {
                            ...
                            if (fileType == 'NICF') {
                                ...
                                if (nicFileName != '') {
                                    ...
                                    $('#nicAttachPathDisplay').html('<a href="policeFileFinder.htm?fileName=' + nicFileName + '" target="_blank"><img src="images/open.png" height="25px" id="nicRemove"/ ></a>');
                                ...
                                if (nicFileNameBack != '') {
                                    ...
                                    $('#nicBackAttachPathDisplay').html('<a href="policeFileFinder.htm?fileName=' + nicFileNameBack + '" target="_blank"><img src="images/open.png" height="25px" id="nicBackRemove"/></a>');
                                ...
                                if (newNicFileName != '') {
                                    ...
                                    $('#newNicAttachPathDisplay').html('<a href="policeFileFinder.htm?fileName=' + newNicFileName + '" target="_blank"><img src="images/open.png" height="25px" id="newNicRemove"/></a>');
                                    $('#newNicAttachPathDisplay').append('&nbsp;&nbsp;<a href="javascript:removeUploadedFile(\'NEWNICF\')"><img src="images/cancel.png" height="20px"/></a>')
                                } else {
                                ...
                                if (newNicFileNameBack != '') {
                                    ...
                                    $('#newNicBackAttachPathDisplay').html('<a href="policeFileFinder.htm?fileName=' + newNicFileNameBack + '" target="_blank"><img src="images/open.png" height="25px" id="newNicBackRemove"/></a>');
                                    $('#newNicBackAttachPathDisplay').append('&nbsp;&nbsp;<a href="javascript:removeUploadedFile(\'NEWNICB\')"><img src="images/cancel.png" height="20px"/></a>')
                                } else {
                                ...
                                if (affidavitFileName != '') {
                                    ...
                                    $('#affidavitUploadPathDisplay').html('<a href="policeFileFinder.htm?fileName=' + affidavitFileName + '" target="_blank"><img src="images/open.png" height="25px"/></a>');
                                    $('#affidavitUploadPathDisplay').append('&nbsp;&nbsp;<a href="javascript:removeUploadedFile(\'AFFIDAVIT\')"><img src="images/cancel.png" height="20px"/></a>');
                                } else {
                                    $('#uploadLetterOfReferencePathDisplay').html('<b><span class="mandatory_field">No file is uploaded!</span></b>');
                                }
                                $("#ajax_loader_affidavit").hide();
