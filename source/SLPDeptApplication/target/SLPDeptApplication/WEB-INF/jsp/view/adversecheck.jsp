...
<s:i18n name="lk.icta.resources.global">
    ...
    <div id="es-container" class="container">
        ...
        <div id="es-content">
            ...
            <c:set var="pageTitle">Internal - Checking Officer (Adverse)</c:set>
            ...
            <div class="middle_content">
                <div>
                    ...
                    <c:set var="submitUrl">searchAdverseCheck.action</c:set>
                    ...
                    <div class="form-group">
                        ...
                        <c:if test="${! empty applicationList && userType==userTypeDisplayVO.checkingOfficerAdverse}">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="updateNicrevisionClearenceAd.action" method="post" id="nicrevisionUpdateForm">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td valign="middle"
                                                    ...
                                                    Clearence Statsu to 'Name Issue Cleared'
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
// 			var emailText=$.trim($('#emailText').val());
        ...
        function updateNICRevision() {
            ...
            var fileBack = $('#nicUploadPathBack').val();
            var isValid = true;
            ...
            if (changedName == null || changedName == '' || changedName == 'undefined') {
                ...
                isValid = false;
            } else if (file == null || file == '' || file == 'undefined' || fileBack == null || fileBack == '' || fileBack == 'undefined') {
