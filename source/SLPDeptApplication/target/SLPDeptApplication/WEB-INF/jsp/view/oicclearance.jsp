...
<s:i18n name="lk.icta.resources.global">
    ...
    <div id="es-container" class="container">
        ...
        <div id="es-content">
            ...
            <c:set var="pageTitle">Internal - OIC</c:set>
            ...
            <div class="middle_content">
                <div>
                    <c:set var="submitUrl">searchOicClearence.action</c:set>
                    ...
                    <div class="form-group">
                        ...
                        <c:if test="${! empty applicationList && userType==userTypeDisplayVO.oicUser}">
        ...
        <div class="modal fade" id="commentInputModalPopUp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <form action="updateCertificateIssuanceOic.action" method="post" id="certificateIssuanceUpdateForm"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <table class="table borderless" id="commentInputTable">
                                ...
                                <tr>
                                    <td><textarea rows="8" name="clearenceVO.comment" id="commentInput"
    ...
    <script language="javascript" type="text/javascript">
        ...
        function saveRow(applicationId) {
            ...
            if (canOicApprove == 1) {
                var name = 'oicApproveStatus_' + applicationId;
                var status = $('input:radio[name=' + name + ']:checked').val();
