...
<body id="bd" >		
	...
	<jsp:include page="../common/header.jsp" /> 
		...
		<div id="es-content"> 
			...
			<c:set var="pageTitle"><s:text name="Search Application to Print"></s:text></c:set>
			...
			<div class="middle_content">
			   ...
			   <div style="display: none;">
				   	<form action="viewPrintApplicationByReferenceNo.action" method="post" id="applicationCompleteModificationForm">
