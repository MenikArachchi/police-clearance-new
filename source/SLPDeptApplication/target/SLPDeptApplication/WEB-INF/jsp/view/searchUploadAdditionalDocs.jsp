...
<body id="bd" >		
	...
	<jsp:include page="../common/header.jsp" /> 
		...
		<div id="es-content"> 
			...
			<c:set var="pageTitle"><s:text name="Search Upload Document Application"></s:text></c:set>
			...
			<div class="middle_content">
				<div>
					<s:form cssClass="form-horizontal" id="myForm"  theme="simple" action="searchApplicationForUploadAndPrint.action" onsubmit="return validateForm()">
							<div class="col-lg-8">
			   ...
			   <div style="display: none;">
				   	<form action="searchUploadDocumentApplication.action" method="post" id="applicationCompleteModificationForm">
						<s:hidden name="applicationId" id="modifyApplicationCompleteFormAppId" />
						<s:hidden name="referenceNo" id="modifyApplicationCompleteFormAppRefNo" />
					</form>
			   </div>
	...
	<script language="javascript" type="text/javascript">
		...
		function editRow(applicationId, refNo){
			applicationId=parseInt(applicationId);
			if(applicationId>0){
				var con=confirm('Are you sure you want to add additional documents?');
				if(con){
					$('#modifyApplicationCompleteFormAppId').val(applicationId);
					$('#modifyApplicationCompleteFormAppRefNo').val(refNo);
		...
		function validateForm(){
			...
			$.get('searchApplicationForUploadAndPrint.action',{
				referenceNo:referenceNumber,
			},function(data){
			  	var applicationId = data.applicationId;
			  	var message = data.message;
			  	if(applicationId>0){
			  		editRow(applicationId, referenceNumber);
				} else {
					alert(message);
				}  	
			});
