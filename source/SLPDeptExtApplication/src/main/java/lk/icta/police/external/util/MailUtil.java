...
//			// Setup mail server
		...
		if (LOG.isDebugEnabled()) {
			LOG.debug("EXIT sendMail in POLICE with return value: " + mailSent);
		}
	...
	/**
	 * @param valueMap -should contain TITLE,BODY_TEXT
	 * @param recieverEmailAddress
	 * @param recieverName
	 * @return
	 * @throws Exception
	 */
	public boolean sendMailFromEmptyTemplate(Map<String,Object> valueMap, String recieverEmailAddress, String recieverName) throws Exception {
	 LOG.info("Inside EmailUtil::sendMailFromEmptyTemplate");
	 boolean mailSent = false;
	 try{
...
//			// Setup mail server
	    ...
	    // 2.1. Prepare the template input:
	   	    // 2.2. Get the template
	    Template template = cfg.getTemplate("police_email_template_empty.ftl");
		//LOG.debug("freemarkerTemplate: " + template);
