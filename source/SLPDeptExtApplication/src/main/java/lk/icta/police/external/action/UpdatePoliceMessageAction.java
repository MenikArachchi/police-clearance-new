...
import lk.icta.police.external.business.UpdatePoliceMessageBusiness;
...
public class UpdatePoliceMessageAction extends ActionSupport implements SessionAware{
	...
	public String updatePoliceMessageRow(){
		System.out.println("===="+addressVO.toBasicMap().toString());
		System.out.println("applicationId :" + applicationId);
		...
		System.out.println("==="+addressVO.getFromDate());
		System.out.println("==="+addressVO.getResponseSentDate());
