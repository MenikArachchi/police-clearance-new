...
<body id="bd" >
	...
	<div id="es-container" class="container" >
		...
		<div id="es-content" >	
				...
				<div id="messagesDiv" style="margin:2px 0px;">
					...
					<div class="middle_content">
						<div>
						<s:form cssClass="form-horizontal" id="myForm"  theme="simple" action="searchReviewApplication.action" onsubmit="return validateForm()"> 
							...
							<c:if test="${! empty applicationList}">							
												...
												<tbody>
													<c:forEach items="${applicationList}" var="applicationVO">
															<c:choose>
																...
																<c:otherwise>
																	<c:choose>
																		<c:when test="${applicationVO.hasResent==1}">
																			<tr style="background-color: #FCDBD8;">
																		</c:when>
																		<c:otherwise>																		
																			<tr>
																		</c:otherwise>														
																		...
																		<c:when test="${userRole==userRoleDisplayVO.nicUserRole || userRole==userRoleDisplayVO.imiUserRole}">
																			<c:choose>																	
																				<c:when test="${applicationVO.hasCurrentUserLocked == 1}">
																					<img src="images/lock.png" style="width: 30px;height:30px;cursor: pointer;" alt="Select" title="Select" id="lockUnlockBtn_${applicationVO.applicationId}" class="basic_image_button" onclick="cancelEditAdverse(${applicationVO.applicationId})" />
																				</c:when>
																				<c:otherwise>
																					<img src="images/unlock.png" style="width: 30px;height:30px;cursor: pointer;" alt="Select" title="Select" id="lockUnlockBtn_${applicationVO.applicationId}" class="basic_image_button" onclick="editRowAdverse(${applicationVO.applicationId})" />
																				</c:otherwise>
																			</c:choose>
																		</c:when>
																		<c:otherwise>
																			<c:choose>																	
																				<c:when test="${applicationVO.hasCurrentUserLocked == 1}">
																					<img src="images/lock.png" style="width: 30px;height:30px;cursor: pointer;" alt="Select" title="Select" id="lockUnlockBtn_${applicationVO.applicationId}" class="basic_image_button" onclick="cancelEdit(${applicationVO.applicationId})" />
																				</c:when>
																				<c:otherwise>
																					<img src="images/unlock.png" style="width: 30px;height:30px;cursor: pointer;" alt="Select" title="Select" id="lockUnlockBtn_${applicationVO.applicationId}" class="basic_image_button" onclick="editRow(${applicationVO.applicationId})" />
																				</c:otherwise>
																			</c:choose>
																		</c:otherwise>
																	</c:choose>
																...
																<td class="text-center-middle" style="vertical-align: middle;">${applicationVO.nic}</td>
																<td class="text-center-middle" style="vertical-align: middle;">${applicationVO.passport}</td>
																<td class="text-center-middle" style="vertical-align: middle;">${applicationVO.applicantNameAsNic}</td>
																<td class="text-center-middle" style="vertical-align: middle;"><fmt:formatDate value="${applicationVO.dateOfBirth}" pattern="dd/MM/yyyy"/></td>
																<td class="text-center-middle" style="vertical-align: middle;">${applicationVO.certificatePostalAddress}</td>
																<c:if test="${userRole==userRoleDisplayVO.phqUserRole}">
																	<td class="text-center-middle" style="vertical-align: middle;">
																		<c:choose>
																			<c:when test="${applicationVO.hasCurrentUserLocked == 1}">
																				<input onclick="" type="button" id="update_pol_message_link_phq_${applicationVO.applicationId}"  alt="Update" value="Update" class="btn btn-primary es-buttton"/>
																			</c:when>
																			<c:otherwise>
																				<input onclick="javascript:void(0)" type="button" id="update_pol_message_link_phq_${applicationVO.applicationId}" disabled="disabled"  alt="Update" value="Update" class="btn btn-primary es-buttton"/>
																			</c:otherwise>
																		</c:choose>
																	</td>
																</c:if>
																	...
																	<td class="text-center-middle" style="vertical-align: middle;">
																		<c:choose>
																			<c:when test="${userRole==userRoleDisplayVO.phqUserRole}">
																				<c:choose>
																					<c:when test="${applicationVO.hasCurrentUserLocked == 1}">
																						<input onclick="viewAddressListPhq(${applicationVO.applicationId})" type="button" id="view_link_phq_${applicationVO.applicationId}"  alt="View" value="View" class="btn btn-primary es-buttton"/>
																					</c:when>
																					<c:otherwise>
																						<input onclick="javascript:void(0)" type="button" id="view_link_phq_${applicationVO.applicationId}" disabled="disabled"  alt="View" value="View" class="btn btn-primary es-buttton"/>
																					</c:otherwise>
																				</c:choose>																				
																			</c:when>
																			<c:otherwise>
																				<c:choose>
																					<c:when test="${applicationVO.hasCurrentUserLocked == 1}">
																						<input onclick="viewAddressListPolice(${applicationVO.applicationId})" type="button" id="view_link_pol_${applicationVO.applicationId}" alt="View" value="View" class="btn btn-primary es-buttton"/>
																					</c:when>
																					<c:otherwise>
																						<input onclick="javascript:void(0)" type="button" id="view_link_pol_${applicationVO.applicationId}" disabled="disabled"  alt="View" value="View" class="btn btn-primary es-buttton"/>
																					</c:otherwise>
																				</c:choose>																				
																			</c:otherwise>
																		</c:choose>
																...
																<c:if test="${!(userRole==userRoleDisplayVO.phqUserRole || userRole==userRoleDisplayVO.polUserRole)}">
																	<c:if test="${userRole==userRoleDisplayVO.nicUserRole || userRole==userRoleDisplayVO.imiUserRole}">
																		<td class="text-center-middle" style="vertical-align: middle;">
																			<c:choose>
																				<c:when test="${applicationVO.hasCurrentUserLocked == 1}">
																					<input type="text" class="form-control"  id="comment_${applicationVO.applicationId}" name="comment">
																				</c:when>
																				<c:otherwise>
																					<input type="text" class="form-control"  id="comment_${applicationVO.applicationId}" name="comment" readonly="readonly" disabled="disabled">
																				</c:otherwise>
																			</c:choose>
																		</td>
																	</c:if>
																	<td class="text-center-middle" style="vertical-align: middle;">																	
																		<c:choose>
																			<c:when test="${applicationVO.hasCurrentUserLocked == 1}">
																				<table>
																					<tr>
																						<td style="vertical-align: middle;"><input style="cursor: pointer;" type="radio" name="clearenceStatus_${applicationVO.applicationId}" value="Y"></td>
																						<td style="vertical-align: middle;">Y</td>
																						<td>&nbsp;&nbsp;</td>
																						<td style="vertical-align: middle;"><input style="cursor: pointer;" type="radio" name="clearenceStatus_${applicationVO.applicationId}" value="N"></td>
																			...
																			<c:otherwise>
																				<table>
																					<tr>
																						<td style="vertical-align: middle;"><input type="radio" style="cursor: pointer;" name="clearenceStatus_${applicationVO.applicationId}" value="Y" readonly="readonly" disabled="disabled"></td>
																						<td style="vertical-align: middle;">Y</td>
																						<td>&nbsp;&nbsp;</td>
																						<td style="vertical-align: middle;"><input type="radio" style="cursor: pointer;" name="clearenceStatus_${applicationVO.applicationId}" value="N" readonly="readonly" disabled="disabled"></td>
																						<td style="vertical-align: middle;">N</td>
																					</tr>
																				</table>
																			</c:otherwise>
																	...
																	<td class="text-center-middle" style="vertical-align: middle;">																			
																		<c:choose>
																			<c:when test="${userRole==userRoleDisplayVO.nicUserRole || userRole==userRoleDisplayVO.imiUserRole}">
																				<c:choose>
																					<c:when test="${applicationVO.hasCurrentUserLocked == 1}">
																						<img src="images/save.png" style="width:20px;height:20px;cursor: pointer;" id="save_image_${applicationVO.applicationId}" alt="Save" title="Save" class="basic_image_button" onclick="loadSaveAdverseIssueType(${applicationVO.applicationId})" />												
																					</c:when>
																					<c:otherwise>
																			...
																			<c:otherwise>
																				<c:choose>
																					<c:when test="${applicationVO.hasCurrentUserLocked == 1}">
																						<img src="images/save.png" style="width:20px;height:20px;cursor: pointer;" id="save_image_${applicationVO.applicationId}" alt="Save" title="Save" class="basic_image_button" onclick="loadLargeComment(${applicationVO.applicationId})" />												
																					</c:when>
																					<c:otherwise>
																						<img src="images/save.png" style="width: 20px;height:20px;cursor: pointer;" id="save_image_${applicationVO.applicationId}" alt="Save" title="Save" class="basic_image_button disabled_image" />					
																					</c:otherwise>												
									...
									<form action="updateAdverseClearenceStatus.action" method="post" id="clearenceUpdateFormAdverse">	
		...
		<div class="modal" id="addressListViewPhqModelPopUp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		 <div class="modal-dialog modal-lg">
   			 <div class="modal-content">
				<div class="modal-header">
				     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				     <h4 class="modal-title">View Stay in SL and place for Clearence Period</h4>
				</div>
					...
					<div class="col-lg-9" id="phq_address_edit_div" style="display: none;">						
						...
						<table width="100%">
							...
							<tr>
								...
								<td><textarea rows="3" cols="10" id="addressEditPhqAddress" class="form-control"></textarea></td>
								<td>&nbsp;</td>
								<td>
							...
							<tr>
								...
								<td><textarea rows="3" cols="10" id="addressEditPhqComment" class="form-control"></textarea></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>						
							</tr>
							<tr><td colspan="4">&nbsp;</td></tr>
							<tr>
								...
								<td><div id="addressEditPhqUpdatedByText" class="input_div"></div></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>						
							</tr>
							<tr><td colspan="4">&nbsp;</td></tr>
							<tr>
								<td>&nbsp;</td>
								<td>
									<input type="checkbox" id="addressEditPhqSendEmail" onclick="showEmailTypeButtonsPhq()" />
							...
							<tr id="emailTypePhqSection" style="display: none;">
								<td><label class="control-label bold-label">Select Email Type To Send</label></td>
								<td>
									<input type="radio" name="emailTypePhq" value="UP" onclick="loadEmailContentPhq()" />Update in police Area <br />
									<input type="radio" name="emailTypePhq" value="IA" onclick="loadEmailContentPhq()" />Incorrect Address or Period of stay
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>						
							</tr>						
							...
							<tr id="emailContentPhqSection" style="display: none;">
								...
								<td>
									<div id="addressEditPhqEmail" contenteditable="true" style="padding: 2px;border: 1px solid black;"></div>
							...
							<tr>
								...
								<td colspan="3" align="left">
									<input type="button" class="btn btn-primary" id="phqSendEmailAddressEditSave" onclick="javascript:void(0)" value="Send Email" />&nbsp;
									<input type="button" class="btn btn-primary" id="phqAddressEditSave" onclick="javascript:void(0)" value="Confirm Changes and Save" />&nbsp;
									<input type="button" class="btn btn-primary" id="phqAddressEditCancel" onclick="javascript:void(0)" value="Cancel" />
								</td>	
							</tr>
							<tr><td colspan="4">&nbsp;</td></tr>
						</table>
		...
		<div class="modal" id="addressListViewPoliceModelPopUp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		 <div class="modal-dialog modal-lg">
   			 <div class="modal-content">
				<div class="modal-header">
				     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				...
				<div class="modal-body">
					...
					<div class="col-lg-9" id="police_address_edit_div" style="display: none;">						
						...
						<table width="100%">
							...
							<tr>
								<td><label class="control-label bold-label">Address: </label></td>
								<td><textarea rows="3" cols="10" id="addressEditPoliceAddress" readonly="readonly" class="form-control"></textarea></td>
								<td>&nbsp;</td>
								<td>
							...
							<tr>
								<td><label class="control-label bold-label">Period From: </label></td>
								<td>
									<input type="text" id="addressEditPoliceFromDate" readonly="readonly" class="form-control"/>
									<label class="control-label bold-label">&nbsp;&nbsp; To:&nbsp;</label>
									<input type="text" id="addressEditPoliceToDate" readonly="readonly" class="form-control"/>
								</td>
								<td>&nbsp;</td>
								<td>
							...
							<tr>
								<td><label class="control-label bold-label">Comment: </label></td>
								<td><textarea rows="3" cols="10" id="addressEditPoliceComment" class="form-control"></textarea></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>						
							</tr>
							<tr><td colspan="4">&nbsp;</td></tr>
							<tr>
								...
								<td colspan="2" align="left">
									<input type="button" class="btn btn-primary" id="policeAddressEditSave" onclick="javascript:void(0)" value="Save" />&nbsp;
									<input type="button" class="btn btn-primary" id="policeAddressEditCancel" onclick="javascript:void(0)" value="Cancel" />
								</td>	
							</tr>
							<tr><td colspan="4">&nbsp;</td></tr>
						</table>
		...
		<div class="modal fade" id="adverseIssueTypeModelModelPopUp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		 <div class="modal-dialog">
				...
				<div class="modal-body">
					...
					<table>
						<tr>
							<td colspan="2">
								<input type="radio" name="adverseIssueType" value="NI" /><label class="control-label bold-label">Name Issue</label> &nbsp;
								<input type="radio" name="adverseIssueType" value="OI" /><label class="control-label bold-label">Other Issue</label> &nbsp;
							</td>
						</tr>
						<tr><td colspan="2">&nbsp;</td></tr>
						<tr>
							<td colspan="2">
								<label class="control-label bold-label">Please add a comment for your action</label> <br />
								<textarea rows="5" cols="90" name="adverseIssueTypeComment" id="adverseIssueTypeComment" class="form-control"></textarea>
							</td>
						</tr>
						<tr><td colspan="2">&nbsp;</td></tr>
						<tr>
							<td colspan="2" align="right" style="text-align: right;">
								<input type="button" class="btn btn-primary" id="adverseIssueTypeSave" onclick="javascript:void(0)" value="Save" />&nbsp;
								<input type="button" class="btn btn-primary" id="adverseIssueTypeCancel" onclick="javascript:void(0)" value="Cancel" />
							</td>
						</tr>
					</table>					
				 </div>				 
		...
		<!--  #####################################################	COMMENT POPUP   ######################################################## -->
		<div class="modal fade" id="commentViewModelPopUp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		 <div class="modal-dialog">
   			 <div class="modal-content">
				<div class="modal-header">
				     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	...
	function saveAddressByPolice(addressId,applicationId){
		...
		if(isValid){
			...
			blockUI();
			if(con){
				$.post('updateAddressPolice.action',{addressId:addressId,policeAddressComment:comment,policeAddressClearenceStatus:clearenceStatus},function(data){
					unBlockUI();	
	...
	function saveAddressByPhq(addressId,applicationId){
		...
		if(isValid){
			...
			blockUI();
			if(con){
				$.post('updateAddressPhq.action',{addressId:addressId,policeAddressComment:comment,policeAddressClearenceStatus:clearenceStatus},function(data){
					unBlockUI();	
					alert(data.addressUpdatedMessage);					
			  	 ...
			  	 if(addressVOList.length>0){			  		
			  		 ...
			  		 $.each(addressVOList,function( index, item ){
			  			...
			  			if(!(item.addressTempVO==null || item.addressTempVO.length<=0 || item.addressTempVO.addressTempId<=0)){
			  				appendText=appendText + '<tr style="background-color:#ACD4F7">';
			  			}else{
			  				appendText=appendText + '<tr>';
			  			}
			  			...
			  			if(!(item.addressTempVO==null || item.addressTempVO.length<=0 || item.addressTempVO.addressTempId<=0)){
			  				appendText=appendText + '<td><input type="text" class="form-control phq_address_list_comment" disabled="disabled" readonly="readonly"  id="address_comment_phq' +  item.addressId  + '" name="comment"></td>';
			  			}else{
			  				appendText=appendText + '<td><input type="text" class="form-control phq_address_list_comment"  id="address_comment_phq' +  item.addressId  + '" name="comment"></td>';
			  			}
			  			...
			  			if(!(item.addressTempVO==null || item.addressTempVO.length<=0 || item.addressTempVO.addressTempId<=0)){
			  				appendText=appendText + '<td style="vertical-align: middle;"><input style="cursor: pointer;" type="radio" disabled="disabled" readonly="readonly" name="address_clearenceStatus_phq_' + item.addressId + '" value="Y"></td>';
			  			}else{
			  				appendText=appendText + '<td style="vertical-align: middle;"><input style="cursor: pointer;" type="radio" onclick="disableEditAddressButtonPhq(' + item.addressId + ',' + applicationId + ')" name="address_clearenceStatus_phq_' + item.addressId + '" value="Y"></td>';
			  			}
			  			...
			  			if(!(item.addressTempVO==null || item.addressTempVO.length<=0 || item.addressTempVO.addressTempId<=0)){
			  				appendText=appendText + '<td style="vertical-align: middle;"><input style="cursor: pointer;" type="radio" disabled="disabled" readonly="readonly"  name="address_clearenceStatus_phq_' + item.addressId + '" value="N"></td>';
			  			}else{
			  				appendText=appendText + '<td style="vertical-align: middle;"><input style="cursor: pointer;" type="radio" onclick="enableEditAddressButtonPhq(' + item.addressId + ',' + applicationId + ')" name="address_clearenceStatus_phq_' + item.addressId + '" value="N"></td>';
			  			}
						...
						if(!(item.addressTempVO==null || item.addressTempVO.length<=0 || item.addressTempVO.addressTempId<=0)){
							appendText=appendText + '<td><img src="images/edit.png" style="width:20px;height:20px;cursor: pointer;" id="addressEditButtonPhq_' + item.addressId + '" alt="Edit" title="Edit" class="basic_image_button" onclick="ediAddressByPhq(' + item.addressId + ',' + applicationId + ')" /></td>';
				  			appendText=appendText + '<td><img src="images/save.png" style="width:20px;height:20px;cursor: pointer;" id="addressSaveButtonPhq_' + item.addressId + '" alt="Save" title="Save" class="basic_image_button disabled_image" onclick="javascript:void(0)" /></td>';
						}else{
							appendText=appendText + '<td><img src="images/edit.png" style="width:20px;height:20px;cursor: pointer;" id="addressEditButtonPhq_' + item.addressId + '" alt="Edit" title="Edit" class="basic_image_button disabled_image" onclick="javascript:void(0)" /></td>';
				  			appendText=appendText + '<td><img src="images/save.png" style="width:20px;height:20px;cursor: pointer;" id="addressSaveButtonPhq_' + item.addressId + '" alt="Save" title="Save" class="basic_image_button" onclick="saveAddressByPhq(' + item.addressId + ',' + applicationId + ')" /></td>';
						}
