...
export default function ChangePasswordPage() {
  ...
  return (
    <>
      <PageTitleBar title="Change Password" homeHref="/dept" showChangePassword />
          ...
          <div className="well">
            ...
            <div className="form-group">
              <div className="col-sm-4">
                <label className="control-label">Email Address <span className="mandatory_field">*</span></label>
              </div>
