...
export async function GET(req: NextRequest) {
  ...
  const ppt     = searchParams.get('ppt');
  ...
  if (ppt)    { conditions.push('a.passport = ?');              params.push(ppt); }
  if (name)   {
  ...
  const sql = `
    SELECT
      a.application_id, a.reference_no, a.nic, a.new_nic, a.passport,
      a.applicant_name_as_nic, a.applicant_name_as_passport,
      a.date_of_birth, a.present_address_local, a.mobile_no,
      a.submitted_date, a.phq_record_lock_status, a.updated_user_id,
